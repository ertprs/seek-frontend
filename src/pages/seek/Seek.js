          ...
          <div className="user">
            ...
            <div className="card-user">
              ...
              <span className="horaPedido">
                ...
                -<strong className="time">{` ${contTime}`}</strong>
              </span>
              <FontAwesomeIcon
                color={
                  props.formaPagamento === formaPagamento.CARTAO
                    ? "#624CAB"
                    : "rgb(76, 171, 100)"
                }
                icon={
          ...
          <div className="w-100 footer">
            <div className="total">
              <span className="total-label">
                TOTAL: <span className="cifrao">R$</span>
                <strong>{props.total.toFixed(2)}</strong>
              </span>
            </div>
            <div className="containerButtons">
              <button
                className="botao clock"
                data-toggle="tooltip"
              ...
              <button
                className="botao check ml-3 mr-3"
                data-toggle="tooltip"
                data-placement="bottom"
